...
export default {
  ...
  methods: {
    initialize() {
      ...
      this.setestimatesAutomobileAction(this.geteditedOrSavedClaimAutomobile.id)
        .then(() => {
    ...
    ...mapActions([
      "setestimatesAutomobileAction",
      "editestimateAutomobileAction",
    ...
    addEstimate() {
      ...
      this.addestimateAutomobileAction(this.editedItem)
        .then((resolve) => {
          ...
          this.editedItem.automobile_id = null;
    ...
    updateEstimate() {
      ...
      var modelUpdate = {
        estimate: {
          ...
          automobile_id: this.editedItem.automobile_id,
    ...
    editItem(item) {
      ...
      this.editedItem.automobile_id = item.estimate.automobile_id;
