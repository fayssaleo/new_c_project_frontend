...
export default {
  ...
  computed: {
    formTitle() {},
    ...mapGetters(["geteditedOrSavedClaimAutomobile","getLiability_letter_files_Data_Automobile"]),
    showDownload() {
      return this.geteditedOrSavedClaimAutomobile.insurance_declaration !=
        null && this.geteditedOrSavedClaimAutomobile.insurance_declaration != ""
        ? true
        : false;
    },
  },
  watch: {
    insurance_followup: {
      ...
      handler(newValue, oldvalue) {
        this.set_insurance_followup_automobile_claim_SetterAction(
          newValue
        ).then(() => {});
      },
    },
    ...
    initialize() {
      if (this.geteditedOrSavedClaimAutomobile.id > 0) {
        this.insurance_followup.date_of_declaration =
          this.geteditedOrSavedClaimAutomobile.date_of_declaration;
        this.insurance_followup.date_of_feedback =
          this.geteditedOrSavedClaimAutomobile.date_of_feedback;

        this.insurance_followup.comment_Insurance =
          this.geteditedOrSavedClaimAutomobile.comment_Insurance;

        this.insurance_followup.Indemnification_of_insurer =
          this.geteditedOrSavedClaimAutomobile.Indemnification_of_insurer;

        this.insurance_followup.currency_indemnisation =
          this.geteditedOrSavedClaimAutomobile.currency_indemnisation;

        this.insurance_followup.deductible_charge_TAT =
          this.geteditedOrSavedClaimAutomobile.deductible_charge_TAT;
