          ...
          <v-row align="center">
            ...
            <v-col class="" cols="12" sm="6">
              ...
              <a
                ...
                v-if="showDownload"
                :href="
                  'http://127.0.0.1:8000/storage/cdn/containers/incident_report/' +
...
export default {
  ...
  watch: {
    dateClaim: {
      ...
      handler(newValue, oldvalue) {
        this.set_date_container_claim_SetterAction(newValue);
      },
    },
    date: {
      handler(newValue, oldvalue) {
  ...
  methods: {
    ...mapActions(["set_date_container_claim_SetterAction"]),
    initialize() {
      if (this.geteditedOrSavedClaimContainer.id > 0) {
        this.dateClaim.incident_date =
          this.geteditedOrSavedClaimContainer.incident_date;
        this.dateClaim.claim_date =
          this.geteditedOrSavedClaimContainer.claim_date;
        this.dateClaim.incident_report =
          this.geteditedOrSavedClaimContainer.incident_report;
        this.dateClaim.incident_reportFile =
          this.geteditedOrSavedClaimContainer.incident_reportFile;
        if (
          this.dateClaim.incident_date != "" &&
        ...
        this.showDownload =
          this.geteditedOrSavedClaimContainer.incident_report != null &&
          this.geteditedOrSavedClaimContainer.incident_report != ""
            ? true
            : false;
      }
