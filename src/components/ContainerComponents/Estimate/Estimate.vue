...
export default {
  ...
  methods: {
    ...
    ...mapActions([
      "setestimatesContainerAction",
      "editestimateContainerAction",
    ...
    addEstimate() {
      this.editedItem.container_id = this.geteditedOrSavedClaimContainer.id;
      ...
      this.addestimateContainerAction(this.editedItem)
        ...
        .catch((err) => {
          console.error("error addestimateContainerAction", err);
          this.setModuleShowToFalseAction();
        });
      this.close();
    },
    updateEstimate() {
      ...
      var modelUpdate = {
        estimate: {
          ...
          container_id: this.editedItem.container_id,
    ...
    editItem(item) {
      ...
      this.editedItem.container_id = item.estimate.container_id;
