...
export default {
  ...
  methods: {
    ...
    showAllClaims() {
      ...
      this.isClaim = true;
      this.loading = true;
      this.setContainersAllClaimAction().then(() => {
        this.claims = [...this.getContainerclaims];
        this.loading = false;
      });
    },
    ...mapActions([
      ...
      "setAll_Attr_CONTAINER_CLAiMAction",
      "emptyAll_Attr_CONTAINER_CLAiMAction",
    ]),
    ...
    deleteItemConfirm() {
      this.deleteContainerClaimAction(this.editedItem).then(() => {
        this.claims = [...this.getContainerclaims];
      });
